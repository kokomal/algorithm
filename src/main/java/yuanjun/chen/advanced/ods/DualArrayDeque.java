...
/**
 * Implements the List<T> interface using two Lists so that insertion/deletions at the front or back
 * of the list are fast. This can be used as an efficient Deque.
 * 
 * @author morin
 * [本人备注] 用2个数组实现Deque
...
public class DualArrayDeque<T> extends AbstractList<T> {
    ...
    /**
     * Rebalance the elements between front and back if necessary
     */
